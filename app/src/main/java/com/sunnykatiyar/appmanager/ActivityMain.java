...
public class ActivityMain extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public static FragmentApps fragmentApps;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPrefFileSettings = getSharedPreferences(PREF_NAME_FILE_SETTINGS,MODE_PRIVATE);
        prefEditFileSettings = sharedPrefFileSettings.edit();

        sharedPrefExternalStorages = getSharedPreferences(PREF_NAME_EXTERNAL_STORAGES,MODE_PRIVATE);
    ...
    private void setFragment(int id){
        ...
        switch(id){
            ...
            case R.id.nav_applist:{
                ...
                ft = fm.beginTransaction();
                ft.replace(R.id.fragment_container, fragmentApps);
                ft.addToBackStack(null);
                ft.commit();
                prefEditAppSettings.putInt(key_last_fragment,id).commit();
                navigationView.getMenu().findItem(id).setChecked(true);
            ...
            case R.id.nav_file_list:{
                ft = fm.beginTransaction();
                ft.replace(R.id.fragment_container, fragmentFiles);
                ft.addToBackStack(null);
                ft.commit();
                prefEditAppSettings.putInt(key_last_fragment,id).commit();
                navigationView.getMenu().findItem(id).setChecked(true);
